...
class AuditService:
    ...
    def record_query_event(
        ...
        *,
        ...
        record = AuditLogRecord(
            ...
            user_id=user_id,
            question=question,
            authorized_document_ids_count=authorized_document_ids_count,
    ...
    def _to_domain(self, record: AuditLogRecord) -> AuditEvent:
        return AuditEvent(
            ...
            authorized_document_ids_count=record.authorized_document_ids_count,
            documents_retrieved=tuple(record.documents_retrieved),
            chunks_used=tuple(record.chunks_used),
            access_decision=record.access_decision,
            strict_scope_blocked=record.strict_scope_blocked,
